...
def safe_create_users():
    ...
    users_data = [
        {'username': 'admin_user', 'email': 'admin@agriconnect.com', 'role': 'admin'},
        {'username': 'farmer_john', 'email': 'john@farm.com', 'role': 'farmer'},
        {'username': 'mary_farm', 'email': 'mary@farm.com', 'role': 'farmer'},
        {'username': 'peter_agri', 'email': 'peter@farm.com', 'role': 'farmer'},
        {'username': 'grace_harvest', 'email': 'grace@farm.com', 'role': 'farmer'},
        {'username': 'samuel_crops', 'email': 'samuel@farm.com', 'role': 'farmer'}
    ]
...
def safe_create_products(categories, farmers, max_products=50):
    ...
    # Sample product names, descriptions, and image IDs
    product_templates = [
        {'name': 'Sweet Bananas', 'description': 'Fresh ripe bananas, perfect for snacking', 'category': 'Fruits', 'image_id': 200},
        {'name': 'Juicy Oranges', 'description': 'Sweet citrus oranges packed with vitamin C', 'category': 'Fruits', 'image_id': 201},
        {'name': 'Fresh Tomatoes', 'description': 'Juicy red tomatoes for cooking', 'category': 'Vegetables', 'image_id': 202},
        {'name': 'Green Peppers', 'description': 'Fresh bell peppers', 'category': 'Vegetables', 'image_id': 203},
        {'name': 'White Rice', 'description': 'Premium quality white rice', 'category': 'Grains', 'image_id': 204},
        {'name': 'Brown Rice', 'description': 'Healthy brown rice with fiber', 'category': 'Grains', 'image_id': 205},
        {'name': 'Black Beans', 'description': 'Protein-rich black beans', 'category': 'Legumes', 'image_id': 206},
        {'name': 'Irish Potatoes', 'description': 'Fresh Irish potatoes for cooking', 'category': 'Tubers', 'image_id': 207},
        {'name': 'Groundnuts', 'description': 'Roasted groundnuts/peanuts', 'category': 'Nuts', 'image_id': 208},
        {'name': 'Fresh Tilapia', 'description': 'Fresh water tilapia fish', 'category': 'Fish', 'image_id': 209}
    ]
    ...
    db.session.commit()
    print(f"Created {len(products)} products with images and price history")
